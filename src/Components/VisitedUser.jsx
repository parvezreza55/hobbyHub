...
const VisitedUser = () => {
  return (
    <div className="w-11/12 mx-auto py-10 mb-20 ">
      <h1 className="text-center text-xl md:text-3xl font-bold my-10">
        Our users
      </h1>
      <div className=" flex flex-col md:flex-row space-y-4 md:space-y-0  md:justify-around bg-base-200 dark:border dark:border-gray-50 rounded-2xl shadow-xl px-10 py-12">
